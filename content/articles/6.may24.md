...
layout: article
title: May 2024
description: Notes for the month of May, 2024
...
otherwise youll get an err that says, an err occurred in the Link component/ something related to useHref being used in the context of a Router
...
1. to solve act warnings, you should use findBy. usually you shouldnt follow the advice of a warning
...
NOTE: you can find articles on hooks ive mentioned above in my blog [here](https://briha.xyz/blog)
